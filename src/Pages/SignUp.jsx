    ...
    <div className="bg-gradient-to-r from-red-100 via-orange-100 to-yellow-100 min-h-screen flex items-center justify-center py-20">
      <div className="bg-white shadow-2xl rounded-lg w-full max-w-md md:max-w-lg lg:max-w-2xl px-6 py-8 lg:py-16">
        ...
        <div className="flex justify-center gap-4 mb-4">
          <button className="bg-red-600 text-white p-4 rounded-full text-lg font-semibold hover:bg-red-700 transition duration-300">
            <FontAwesomeIcon icon={faGoogle} />
          </button>
          <button className="bg-blue-600 text-white p-4 rounded-full text-lg font-semibold hover:bg-blue-700 transition duration-300">
            <FontAwesomeIcon icon={faFacebook} />
          </button>
          <button className="bg-blue-500 text-white p-4 rounded-full text-lg font-semibold hover:bg-blue-600 transition duration-300">
